...
export default function DashboardFooter({ DashboardnavLinks }: { DashboardnavLinks: Array<{ href: string; label: string }> }) {
  return (
    <footer className="flex flex-col md:flex-row lg:flex-row items-center justify-center flex-nowrap bg-[#27374D] p-6 w-full rounded-md ">
      ...
      {/* navbar */}
      <div className="flex-grow w-full h-full py-4 rounded-xl bg-[#526D82] flex flex-row justify-center items-cenetr flex-wrap">
